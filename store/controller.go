...
func (c *Controller) Signup(w http.ResponseWriter, r *http.Request){
	...
	encrypedPassword := encrypt(user.Password)  // from encryption.go 
	...
	// We reach this point if the User we correctly stored in the database, and the default status of 200 is sent back
}
...
func (c *Controller) Signin(w http.ResponseWriter, r *http.Request){
	...
	result := c.Repository.GetPasswordByUser(user.Username)
	if err != nil {
	...
	decryptedPassword := decrypt(result.Password)  // from encryption.go 
